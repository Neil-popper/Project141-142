...
export default class HomeScreen extends Component {
  ...
  getBook = () => {
    const url = "http://localhost:5000/get-book";
    axios
      .get(url)
      .then(response => {
  ...
  likedBook = () => {
    const url = "http://localhost:5000/liked-book";
    axios
      .post(url)
      .then(response => {
        this.getBook();
  ...
  unlikedBook = () => {
    const url = "http://localhost:5000/unliked-book";
    axios
      .post(url)
      .then(response => {
        this.getBook();
          ...
          <View style={styles.headerContainer}>
            <Header
              ...
              rightComponent={{
                ...
                onPress: () =>
                  this.props.navigation.navigate("RecommendedBook")
              }}
            ...
            <View style={styles.subBottomContainer}>
              ...
              <View style={styles.lowerBottomContainer}>
                <View style={styles.iconButtonContainer}>
                  <TouchableOpacity onPress={this.likedBook}>
                    <Icon
                      reverse
                      name={"check"}
                      type={"entypo"}
                  ...
                  <TouchableOpacity onPress={this.unlikedBook}>
                    <Icon
                      reverse
                      name={"cross"}
                      type={"entypo"}
